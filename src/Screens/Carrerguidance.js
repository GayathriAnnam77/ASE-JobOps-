...
export default function Carrerguidance() {
  return (
    <div >
        <Navbar/>
        <div className='total' style={{ height:'100vh',textAlign:"center", background: "linear-gradient(to bottom, #e1e4e6, #1d415e)", color:"white"}}>
...
career counselling session</h1>
            ...
            <h2 className='button3' style={{background:"#1d415e", color:"white", cursor:"pointer"}} >Book an Appointment</h2>
            </div>
        </div>
        </div>
        <div>
